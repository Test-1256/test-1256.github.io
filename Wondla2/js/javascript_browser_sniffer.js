...
//          Michael Hopkins
// 081223 - Added is_macintel, per Nicolas Hognon
// 091016 - Added is_maciphoneos, per Nicolas Hognon
// 091217 - Added is_winvista and is_winseven per Nicolas Hognon
// 100106 - Added is_ie64, is_ie8 and is_ie8up per Nicolas Hognon
//
...
//
   ...
   var is_fx_ver = is_moz_ver;
	...
	// ADDED BY NICOLAS HOGNON
    var is_ie8   = (is_ie && is_major == 8);
    var is_ie8up = (is_ie && is_minor >= 8);

	// ADDED BY NICOLAS HOGNON
	var is_ie64  = (agt.indexOf("win64") != -1 || agt.indexOf("x64") != -1 || appVer.indexOf("win64") != -1 || appVer.indexOf("x64") != -1);
...
// KNOWN BUG: On AOL4, returns false if IE3 is embedded browser
	...
	// ADDED BY NICOLAS HOGNON
    var is_winvista = ((agt.indexOf("windows nt 6.0")!=-1) || (agt.indexOf("windows vista")!=-1));
	// ADDED BY NICOLAS HOGNON
    var is_winseven = ((agt.indexOf("windows nt 6.1")!=-1) || (agt.indexOf("windows seven")!=-1));
    ...
    // ADDED BY NICOLAS HOGNON
    var is_maciphoneos = (is_mac && ((agt.indexOf("iphone os")!=-1) || (agt.indexOf("iphone")!=-1) || (agt.indexOf("ipod")!=-1)));
...
// see http://webref.com/js/column84/2.html
   ...
   if ((is_nav||is_opera||is_moz||is_fb||is_fx||is_safari||is_chrome)||
       (is_mac&&is_ie5up)) {
